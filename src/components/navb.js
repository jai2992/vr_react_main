    ...
    <Nav>
        ...
        <NavMenu>
            <a>
                ...
                <Link to="/signin" style={{ textDecoration: 'none', color: 'inherit' }}><span>HOME</span></Link>
            </a>
            <a>
                {/* <img src="/images/search-icon.svg" alt=""></img> */}
                <Link to="/signin" style={{ textDecoration: 'none', color: 'inherit' }}><span>PHOBIA</span></Link>
            </a>
            <a>
                {/* <img src="/images/watchlist-icon.svg" alt=""></img> */}
                <Link to="/signin" style={{ textDecoration: 'none', color: 'inherit' }}><span>ABOUT</span></Link>
            </a>
            <a>
                {/* <img src="/images/original-icon.svg" alt=""></img> */}
                <Link to="/signin" style={{ textDecoration: 'none', color: 'inherit' }}><span>DEMO VR</span></Link>
            </a>
            <a>
